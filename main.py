...
def get_text(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        box = messagebox.showinfo("Winner", "Игрок 1 победил!")
    elif winner(board, "O"):
        gb.destroy()
        box = messagebox.showinfo("Winner", "Игрок 2 победил")
    elif (isfull()):
        gb.destroy()
...
def play():
    ...
    B2 = Button(menu, text="Против Игрока", command=wpl, activeforeground='red',
